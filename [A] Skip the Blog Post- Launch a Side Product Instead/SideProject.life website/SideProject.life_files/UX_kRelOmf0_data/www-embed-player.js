...
var yd=vd,zd=wd;function Bd(a,b,c){var d="script";d=void 0===d?"":d;var e=a.createElement("link");Cb(e,b,"preload");d&&(e.as=d);c&&(e.nonce=c);if(a=a.getElementsByTagName("head")[0])try{a.appendChild(e)}catch(f){}}
...
;function S(a,b){qa(a)&&(a=Pd(a));return window.setTimeout(a,b)}
...
function he(a,b){var c=ie(a),d=document.getElementById(c),e=d&&Sd(d,"loaded"),f=d&&!e;if(e)b&&b();else{if(b){e=Zd(c,b);var g=""+(b[sa]||(b[sa]=++ta));je[g]=e}f||(d=ke(a,c,function(){Sd(d,"loaded")||(Qd(d),be(c),S(y(ce,c),0))}))}}
...
b.oa&&0<b.timeout&&(f=S(function(){e||(e=!0,Ud(f),b.oa.call(b.context||p))},b.timeout))}else Ce(a,b)}
...
b.L&&0<b.timeout&&(f=S(function(){e||(e=!0,g.abort(),Ud(f),b.L.call(b.context||p,g))},b.timeout))}
...
;function Ve(){}
n(Ve,Se);function Ue(a,b,c){isNaN(c)&&(c=void 0);var d=v("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):S(a,c||0)}
...
na(Ve);Ve.getInstance();var Xe=[],Ye=!1;function Ze(){if("1"!=Va(Od(),"args","privembed")){var a=function(){Ye=!0;"google_ad_status"in window?O("DCLKSTAT",1):O("DCLKSTAT",2)};
...
t("ytytLoggingTransportCapturedTime_",v("ytLoggingTransportCapturedTime_")||{},void 0);function xf(a,b){tf[a.endpoint]=b;if(R("very_optimistically_create_gel_client"))for(var c in W)if(!sf[c]){var d=tf[c];d&&(sf[c]=new d)}a.W?(c=a.W,d={},c.videoId?d.videoId=c.videoId:c.playlistId&&(d.playlistId=c.playlistId),vf[a.W.token]=d,c=yf(a.endpoint,a.W.token)):c=yf(a.endpoint);c.push(a.payload);c.length>=(Number(R("web_logging_max_batch")||0)||20)?zf():Af()}
...
function Af(){Ud(uf);uf=S(zf,P("LOGGING_BATCH_TIMEOUT",1E4))}
...
function bg(a){var b=cg(a),c=document.getElementById(b),d=c&&Sd(c,"loaded");d||c&&!d||(c=dg(a,b,function(){Sd(c,"loaded")||(Qd(c),be(b),S(y(ce,b),0))}))}
...
st:"serverTimeMs",vph:"viewportHeight",vpw:"viewportWidth",yt_vis:"isVisible"},wg="ap c cver ei srt yt_fss yt_li plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),xg="isNavigation isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber isVisible watchInfo.isPlaylist".split(" "),
yg=!1;
...
function Tg(a){if(!a.g){var b=Sg(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.M=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||Wg(a)):a.ka=S(function(){Tg(a)},50)}}
...
l.V=function(a,b){var c=this,d=Og(this,b);if(d){if(!(0<=wa(this.ta,a)||this.i[a])){var e=Yg(this,a);this.F&&this.F(a,e)}this.w.subscribe(a,d);"onReady"==a&&this.o&&S(function(){d(c.f)},0)}};
...
function Yg(a,b){var c="ytPlayer"+b+a.G;a.i[b]=c;p[c]=function(c){var d=a.b&&a.b.args&&a.b.args.fflags;if(d&&0>d.indexOf("use_html5_player_event_timeout=true"))a.w.J(b,c);else{var f=S(function(){if(!a.g){a.w.J(b,c);var d=a.O,e=String(f);e in d&&delete d[e]}},0);
Za(a.O,String(f))}};
return c}
...
;var Zg={},$g="player_uid_"+(1E9*Math.random()>>>0);function ah(a){var b="player";b=r(b)?Gb(b):b;var c=$g+"_"+(b[sa]||(b[sa]=++ta)),d=Zg[c];if(d)return d.ha(a),d.f;d=new Mg(b,c);Zg[c]=d;be("player-added",d.f);nc(d,y(bh,d));S(function(){d.ha(a)},0);
return d.f}
...
function Kh(a,b){S(function(){Sc(wh().then(Hh,function(a){return Ih(b,a)}),ma)},a)}
...
n(Mh,B);Mh.prototype.name="YuzuError";function Nh(){var a=new Mh("ID is missing"),b=new Mh("Timeout"),c=null,d=!1;Kd(function(){c=Id();d=!0});
...
;function Oh(a){if("1"!==Va(Od(),"args","privembed")){a&&!v("yt.ads.biscotti.getId_")&&t("yt.ads.biscotti.getId_",Gh,void 0);try{var b=Lh();if(R("enable_yuzu")){v("yt.ads.yuzu.getId_")||t("yt.ads.yuzu.getId_",Nh,void 0);try{var c=v("yt.ads.yuzu.getId_")()}catch(d){c=Kc(d)}}else c=Kc(new Mh("unimplemented"));Oc([b,c]).then(function(a){var b=a[0];a=a[1];if(b.Z||a.Z){b=b.value;a=a.value;var c={};c.dt=Sb;c.flash=zd||"0";a:{try{var d=window.top.location.href}catch(Qa){d=2;break a}d=null!=d?d==window.document.location.href?
...
F.navigator.mimeTypes.length);d.ca_type=yd?"flash":"image";if(R("enable_server_side_search_pyv")||R("enable_server_side_mweb_search_pyv")){k=window;try{var m=k.screenX;var u=k.screenY}catch(Qa){}try{var Z=k.outerWidth;var Ca=k.outerHeight}catch(Qa){}try{var ug=k.innerWidth;var vg=k.innerHeight}catch(Qa){}m=[k.screenLeft,k.screenTop,m,u,k.screen?k.screen.availWidth:void 0,k.screen?k.screen.availTop:void 0,Z,Ca,ug,vg];u=window.top;try{var T=(u||window).document,Pa="CSS1Compat"==T.compatMode?T.documentElement:
T.body;var Da=(new Fb(Pa.clientWidth,Pa.clientHeight)).round()}catch(Qa){Da=new Fb(-12245933,-12245933)}T={};Pa=0;p.SVGElement&&p.document.createElementNS&&(Pa|=1);T.bc=Pa;T.bih=Da.height;T.biw=Da.width;T.brdim=m.join();Da=(T.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Qb.visibilityState||Qb.webkitVisibilityState||Qb.mozVisibilityState||""]||0,T.wgl=!!F.WebGLRenderingContext,T);for(var Ad in Da)d[Ad]=Da[Ad]}void 0!==b&&(d.bid=b);void 0!==a&&(d.anid=a);d.bsq=Ph++;Ie("//www.youtube.com/ad_data_204",
{Da:!1,A:d})}});
S(Oh,18E5)}catch(d){Q(d)}}}
